      ...
      <div className="flex items-center gap-1">
        <div class="relative">
          <span class="relative group flex items-center gap-1 cursor-pointer">
            ...
            <span class="bg-zinc-500 text-xs text-white w-44 py-3 px-2 rounded-md  shadow-lg absolute top-full left-1/2 transform -translate-x-1/2 mt-2 opacity-0 group-hover:opacity-100">
